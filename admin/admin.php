  ...
  <div class="container-fluid">
    <div class="row min-vh-100">
      ...
      <div class="col-10 p-5 mt-5">
        ...
        <hr>
        <button class="btn btn-success mt-3" data-bs-toggle="modal" data-bs-target="#tambahModal"><i class="bi bi-person-plus"></i> Tambah Admin</button>
        <!-- Modal Tambah -->
          ...
          <tbody>
            ...
            <?php foreach ($admin as $row) : ?>
              <tr>
                ...
                <td>
                  <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editModal<?= $row["212279_id_user"]; ?>"><i class='bi bi-pencil'></i> Edit</button>
                  <a href="./controller/hapusAdmin.php?id=<?= $row["212279_id_user"]; ?>" class="btn btn-danger"><i class='bi bi-trash-fill'></i> Hapus</a>
                </td>
